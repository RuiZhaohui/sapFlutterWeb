                  ...
                  child: ListView(
                    ...
                    children: <Widget>[
                      _notShowDevice.contains(widget.order.ILART) ? Container() : ListItemWidget(
                        ...
                        actionArea: widget.order.ILART == "N01" ? Icon(CupertinoIcons.right_chevron, color: Color.fromRGBO(94, 102, 111, 1),) : Container(),
                        onTap: () {
                                  ...
                                  if (map != null) {
                                    ...
                                    this
                                      ...
                                      this
                                          ...
                                          .then((success) async {
                                        if (success) {
                                          if (widget.order.ILART == "N06" || widget.order.ILART == "N10") {
