...
class DefaultPasswordAndPhoneNumberChangePage extends StatefulWidget {
  @override
  State createState() => _DefaultPasswordAndPhoneNumberChangePageState();
}

class _DefaultPasswordAndPhoneNumberChangePageState
    extends State<DefaultPasswordAndPhoneNumberChangePage> {
              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  child: ButtonBarWidget(
                    button: Container(
                      child: ButtonWidget(
                        child: Text("确认保存", style: TextStyle(color: Color.fromRGBO(33, 127, 184, 1)),),
                        ...
                        onPressed: () {
                          ...
                          } else if (this._phoneNumberController.text == null ||
