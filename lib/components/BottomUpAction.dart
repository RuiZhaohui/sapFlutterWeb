...
/// 底部弹出框
class BottomUpAction extends StatefulWidget {
  BottomUpAction({Key key, this.list, this.onItemClickListener})
      : assert(list != null),
        super(key: key);
  final list;
  final OnItemClickListener onItemClickListener;
  @override
  _BottomUpActionState createState() => _BottomUpActionState();
}
typedef OnItemClickListener = void Function(int index);

class _BottomUpActionState extends State<BottomUpAction> {
...
//    print(deviceWidth);
    ...
    var height = ((widget.list.length+1) * 60).toDouble();
