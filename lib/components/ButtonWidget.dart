...
class _ButtonWidgetState extends State<ButtonWidget> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(ButtonWidget old) {
  ...
  Widget build(BuildContext context) {
    ...
    CupertinoTheme.of(context).textTheme.textStyle.copyWith(color: foregroundColor, fontSize: widget.fontSize);
          ...
          child: FadeTransition(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                ...
                color: Colors.white,
                border: Border.all(color: backgroundColor != null && !enabled
              ...
              child: Padding(
                ...
                child: Center(
                  ...
                  child: DefaultTextStyle(
                    style: textStyle,
                    child: IconTheme(
                      data: IconThemeData(color: backgroundColor != null && !enabled
                      ? widget.disabledColor ?? _kDisabledBackground
                          : backgroundColor),
                      child: widget.child,
                    ),
