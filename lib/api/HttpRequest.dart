...
//        headers: {"Authorization": "Basic RGV2MDM6MTIzNDU2", "nimabi": {"aaa":"aaa"}}, // 开发
...
//    print(xml);
      try {
        Response response = await http.post("/proxy",
            data: {
  ...
  static listNoPlanOrder(String PERNR, String CPLGR, String MATYP, String SORTB, String WCTYPE, String ASTTX, String AUART, List<String> ItWxfz, Function(List<Order> t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      Response response = await http.post("/proxy",
          data: {
            "path": "/zpm_search_order_zpm1/888/zpm_search_order_zpm1/zpm_search_order_zpm1",
            "xml": xml.toXmlString()
          },
      );
      return await onSuccess(XmlUtils.readNoPlanOrderXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static listPlanOrder(String PERNR, String CPLGR, String MATYP, String SORTB, String WCTYPE, String ASTTX, String AUART, List<String> ItWxfz, Function(List<Order> t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      Response response = await http.post("/proxy",
          data: {
            "path": "/zpm_search_order_zpm2/888/zpm_search_order_zpm2/zpm_search_order_zpm2",
            "xml": xml.toXmlString()
          },
      );
  ...
  static listAssisantOrder(String PERNR, String CPLGR, String MATYP, String SORTB, String WCTYPE, String ASTTX, String AUART, List<String> ItWxfz, Function(List<Order> t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      Response response = await http.post("/proxy",
          data: {
            "path": "/zpm_search_order_zpm3/888/zpm_search_order_zpm3/zpm_search_order_zpm3",
            "xml": xml.toXmlString()
          },
      );
      return await onSuccess(XmlUtils.readAssisantOrderXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static listBlockOrder(String PERNR, String CPLGR, String MATYP, String SORTB, String WCTYPE, String ASTTX, String AUART, List<String> ItWxfz, Function(List<Order> t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      Response response = await http.post("/proxy",
          data: {
            "path": "/zpm_search_order_zpm4/888/zpm_search_order_zpm4/zpm_search_order_zpm4",
            "xml": xml.toXmlString()
          },
      );
  ...
  static reportOrderDetail(String QMNUM, Function(ReportOrder t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      Response response = await http.post("/proxy",
          data: {
            "path": "/zpm_search_ordermess/888/zpm_search_ordermess/zpm_search_ordermess",
            "xml": xml.toXmlString()
          },
      );
      return await onSuccess(XmlUtils.readReportOrderDetailXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static repairOrderHistory(String AUFNR, Function(List<RepairHistory> t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      ...
      return await onSuccess(XmlUtils.readRepairOrderHistoryXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static repairOrderDetail(String AUFNR, Function(prefix0.RepairOrder t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      ...
      return await onSuccess(XmlUtils.readRepairOrderDetailXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static otherDevice(String AUFNR, Function(List<Device> t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      ...
      return await onSuccess(XmlUtils.readOtherDeviceXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static listProblemDescription(String type, Function(List<ProblemDescription> t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      Response response = await http.post("/proxy",
          data: {
            "path": "/zpm_search_katalogart/888/zpm_search_katalogart/zpm_search_katalogart",
            "xml": xml.toXmlString()
          },
      );
      return await onSuccess(XmlUtils.readProblemDescriptionXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  String FECOD, String FETXT, String CPLGR, String MATYP, String MSAUS, String APPTRADENO, Function(Map<String, String> t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      ...
      return await onSuccess(XmlUtils.readReportOrderXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static createRepairOrder(String PERNR, String INGRP, String ILART, String QUNUM, String EQUNR, String TPLNR, String FEGRP,
    ...
    try {
      ...
      return await onSuccess(XmlUtils.readRepairOrderXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static changeOrderStatus(String PERNR, String QMNUM, String AUFNR, String APPSTATUS, String APPTRADENO, String URGRP, String URCOD,
    ...
    try {
      Response response = await http.post("/proxy",
          data: {
            "path": "/zpm_change_order_status/888/zpm_change_order_status/zpm_change_order_status",
            "xml": xml.toXmlString()
          },
      );
      return await onSuccess(XmlUtils.readChangeOrderXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static outerRepair(String AUFNR, String PERNR, Function(bool t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      ...
      return await onSuccess(XmlUtils.readOuterRepairXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static completeOrder(String PERNR, String AUFNR, String APPSTATUS, String APPTRADENO, Function(bool t) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      ...
      return await onSuccess(XmlUtils.readCompleteOrderXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  /// 维修工单添加物料
   static addMateriel(String AUFNR, String MATNR, String MAKTX, int MENGE, String EQUNR, Function(bool) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      Response response = await http.post("/proxy",
          data: {
            "path": "/zpm_change_components/888/zpm_change_components/zpm_change_components",
            "xml": xml.toXmlString()
          },
      );
      return await onSuccess(XmlUtils.readAddMaterielXml(response.data['data']));
    } on DioError catch(e) {
      return await onError(e);
    }
  }
  ...
  static historyOrder(String PERNR, String WCTYPE, Function(List<Order>) onSuccess, Function(DioError err) onError) async {
    ...
    try {
      Response response = await http.post("/proxy",
          data: {
            "path": "/zpm_search_order_history/888/zpm_search_order_history/zpm_search_order_history",
            "xml": xml.toXmlString()
          },
      );
